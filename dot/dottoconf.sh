...
sudo pacman -S ranger firefox alacritty neovim xclip fish nautilus nitrogen rofi rofi-emoji unzip okular fcitx fcitx-hangul fcitx-qt5 fcitx-configtool kcm-fcitx adobe-source-han-sans-otc-fonts adobe-source-han-serif-otc-fonts scrot xorg-xinput brightnessctl ttf-joypixels fuse ttf-dejavu noto-fonts tlp acpi_call-lts lxappearance arc-gtk-theme
